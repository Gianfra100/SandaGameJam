...
public class AudioManager : MonoBehaviour
{
    ...
    private IEnumerator RecycleWhenDone(AudioSource src, Action onComplete = null)
    {
    ...
    public AudioSource PlaySound<TEnum>(
        TEnum key,
        float volume = 1f,
        bool loop = false,
    ...
    public AudioSource Play2DSound<TEnum>(TEnum key, float volume = 1, bool loop = false, Action onComplete = null) where TEnum : Enum
    {
        var src = PlaySound(key, volume, loop, 0, onComplete);
        return src;
    }
    ...
    private IEnumerator FadeMusicVolume(float targetVolume, float duration, Action onComplete = null)
    {
    ...
    public void FadeMusic(float targetVolume = 0f, float fadeDuration = 1f)
    {
